...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_post', (
            ...
            ('slug', self.gf('django.db.models.fields.SlugField')(blank=True, unique=True, default='', max_length=255)),
    ...
    models = {
        ...
        'blog.post': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'blank': 'True', 'unique': 'True', 'default': "''", 'max_length': '255'}),
