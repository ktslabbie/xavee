...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_post', (
            ...
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255, unique=True, default='', blank=True)),
    ...
    models = {
        ...
        'blog.post': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '255', 'unique': 'True', 'default': "''", 'blank': 'True'}),
