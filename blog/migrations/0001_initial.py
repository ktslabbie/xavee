...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_post', (
            ...
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, default='', blank=True, max_length=255)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('content', self.gf('tinymce.models.HTMLField')()),
            ('published', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], related_name='posts')),
        ))
    ...
    models = {
        ...
        'blog.post': {
            'Meta': {'object_name': 'Post', 'ordering': "['-created_at', 'title']"},
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'default': "''", 'blank': 'True', 'max_length': '255'}),
