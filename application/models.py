...
class Developer(BaseModel):
    ...
    name = models.CharField("Developer name", max_length=256, help_text="The name of the developer.")
...
class Category(BaseModel):
    ...
    name = models.CharField("Category name", max_length=64, help_text="The name of the category.")
...
class Version(BaseModel):
    ...
    appstore_id = models.IntegerField("Appstore ID", blank=True, null=True, default='', help_text="This is the ID from the Apple app store.")
    ...
    def __unicode__(self):
        return u'%s (%s version)' % (self.application.title, dicts.PLATFORMS.get(self.platform))


class Ranking(models.Model):
    ''' Database model for App version rankings. '''
    version = models.ForeignKey(Version, related_name="rankings")
...
class ITunesRating(BaseModel):
    ...
    version = models.OneToOneField(Version, primary_key=True, related_name='itunes_rating')
