...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'application_category', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.name_ja'
        db.add_column(u'application_category', 'name_ja',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'application_category', 'name_en')

        # Deleting field 'Category.name_ja'
        db.delete_column(u'application_category', 'name_ja')
