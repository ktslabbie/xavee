...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.multi_build'
        db.add_column(u'application_application', 'multi_build',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.multi_build'
        db.delete_column(u'application_application', 'multi_build')
