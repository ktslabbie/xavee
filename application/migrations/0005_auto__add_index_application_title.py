...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Application', fields ['title']
        db.create_index(u'application_application', ['title'])


    def backwards(self, orm):
        # Removing index on 'Application', fields ['title']
        db.delete_index(u'application_application', ['title'])
