...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Developer.xavee_score'
        db.add_column(u'application_developer', 'xavee_score',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Developer.xavee_score'
        db.delete_column(u'application_developer', 'xavee_score')
    ...
    models = {
        ...
        u'application.developer': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'unique': 'True', 'max_length': '256', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'xavee_score': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True'})
        },
