...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Application.xavee_score'
        db.add_column(u'application_application', 'xavee_score',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Application.xavee_score'
        db.delete_column(u'application_application', 'xavee_score')
