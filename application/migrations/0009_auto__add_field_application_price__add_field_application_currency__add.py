...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'application_application', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'Application.currency'
        db.add_column(u'application_application', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='USD', max_length=3),
                      keep_default=False)

        # Adding field 'Application.release_date'
        db.add_column(u'application_application', 'release_date',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'application_application', 'price')

        # Deleting field 'Application.currency'
        db.delete_column(u'application_application', 'currency')

        # Deleting field 'Application.release_date'
        db.delete_column(u'application_application', 'release_date')
