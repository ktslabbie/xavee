...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorldRanking.currency'
        db.add_column(u'application_worldranking', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='USD', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorldRanking.currency'
        db.delete_column(u'application_worldranking', 'currency')
