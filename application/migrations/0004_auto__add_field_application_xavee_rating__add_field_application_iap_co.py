...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.xavee_rating'
        db.add_column(u'application_application', 'xavee_rating',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Application.iap_count'
        db.add_column(u'application_application', 'iap_count',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Application.iap_sum'
        db.add_column(u'application_application', 'iap_sum',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Application.review_quality'
        db.add_column(u'application_application', 'review_quality',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.xavee_rating'
        db.delete_column(u'application_application', 'xavee_rating')

        # Deleting field 'Application.iap_count'
        db.delete_column(u'application_application', 'iap_count')

        # Deleting field 'Application.iap_sum'
        db.delete_column(u'application_application', 'iap_sum')

        # Deleting field 'Application.review_quality'
        db.delete_column(u'application_application', 'review_quality')
    ...
    models = {
        u'application.application': {
            ...
            'xavee_rating': ('django.db.models.fields.SmallIntegerField', [], {'default': '0', 'null': 'True'})
        },
